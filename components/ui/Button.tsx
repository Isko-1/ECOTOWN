...
const variants: Record<Variant, string> = {
  ...
  white: "bg-white text-eco-900 hover:bg-eco-50 border border-white/80 shadow-md font-bold",
  outline: "bg-transparent text-eco-800 hover:bg-eco-50 border border-eco-200",
};
